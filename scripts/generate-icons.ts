...
async function generateIcons() {
    ...
    for (const file of svgFiles) {
        ...
        // 1. Remove fixed colors and replace with currentColor
        // HeroIcons solid often use fill="#0F172A", outline uses stroke
        ...
        // 2. Ensure it doesn't have hardcoded width/height if we want to control it via class
        // But let's keep it 1em or original size as default 
        // Heroicons usually don't have width/height in the svg tag, but yours do.
        // Let's make them respond to sizing classes like 'size-6'
        svgContent = svgContent.replace(/width="\d+"/, 'width="1em"')
        svgContent = svgContent.replace(/height="\d+"/, 'height="1em"')
