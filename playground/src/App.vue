<template>
    <div class="container">
        ...
        <div class="section">
            <h2>Cards</h2>
            <div class="row">
                <Card header="Simple Card" style="width: 300px">
                    This is a simple card body.
                </Card>

                <Card header="Hover Shadow" shadow="hover" style="width: 300px">
            ...
            <div class="row">
                <Card style="width: 300px">
                    <template #header>
                        <h3>Custom Slot Header</h3>
                    </template>
                    Content with header and footer slots.
                    <template #footer>
                        Footer Content
                    </template>
                </Card>
        ...
        <div class="section">
            <h2>Icons</h2>
            <div class="row">
                <BeakerIcon class="icon-md text-primary" />
                <PlusCircleIcon class="icon-md text-primary" />
            </div>
        </div>
    </div>
</template>
...
import { PlusCircleIcon } from '@bestiary-ui/icons/24/solid';
</script>
